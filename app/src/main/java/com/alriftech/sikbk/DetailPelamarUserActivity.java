...
public class DetailPelamarUserActivity extends AppCompatActivity {
    Core core;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new getUserData().execute(id_user);
        ...
        protected void onPostExecute(String json){
            try {
                ...
                for (int i = 0; i < jdata.length(); i++) {
                    ...
                    Picasso.with(DetailPelamarUserActivity.this).invalidate(url);
                    Picasso.with(DetailPelamarUserActivity.this).load(url).networkPolicy(NetworkPolicy.NO_CACHE).memoryPolicy(MemoryPolicy.NO_CACHE).into(imgUser);
    ...
    private class getUserPendidikan extends AsyncTask<String,String,String> {
        ...
        protected void onPostExecute(String json){
            try {
                ...
                SimpleAdapter sa = new SimpleAdapter(DetailPelamarUserActivity.this, mylist, R.layout.lst_row_pendidikan,
    ...
    private class getUserPekerjaan extends AsyncTask<String,String,String> {
        ...
        protected void onPostExecute(String json){
            try {
                ...
                SimpleAdapter sa = new SimpleAdapter(DetailPelamarUserActivity.this, mylist, R.layout.lst_row_pekerjaan,
